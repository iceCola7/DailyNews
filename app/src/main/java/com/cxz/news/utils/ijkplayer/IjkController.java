package com.cxz.news.utils.ijkplayer;
...
import com.cxz.news.utils.ijkplayer.utils.MeasureHelper;
import com.cxz.news.utils.ijkplayer.utils.StringHelper;
import com.cxz.news.utils.ijkplayer.utils.ViewHelper;
import com.cxz.news.utils.ijkplayer.widget.media.IMediaController;
import com.cxz.news.utils.ijkplayer.widget.media.IjkVideoView;
import com.cxz.news.utils.ijkplayer.widget.view.ProgressView;
...
public class IjkController implements IMediaController, View.OnTouchListener, View.OnClickListener, ProgressView.OnProgressChangeListener {
    ...
    private void initPopupWindow(String name) {
        ...
        XLog.e("----->" + getScreenBrightness(mContext));
                ...
                if (mLastY != y) {
                    ...
                    if (x > mView.getWidth() / 2) {
                        ...
                        if (Math.abs(dy) >= mTouchSlop / 2) {
                            ...
                            mIvBrightnessVolume.setImageResource(R.mipmap.ic_volume_up_white);
                        ...
                        if (Math.abs(dy) >= mTouchSlop / 2) {
                            ...
                            mLlBrightnessVolume.setVisibility(View.VISIBLE);
                            mIvBrightnessVolume.setVisibility(View.VISIBLE);
                            mIvBrightnessVolume.setImageResource(R.mipmap.ic_brightness_6_white);
    ...
    public void onClick(View v) {
        ...
        if (i1 == R.id.iv_back) {// 2016/9/9 0009 退出
            ...
            if (mIjkVideoView != null) {
                ...
                int id = R.mipmap.ic_transform_white;
                switch (ratio) {
                    case "适应屏幕":
                        id = R.mipmap.ic_transform_white;
                        break;
                    case "剪切":
                        id = R.mipmap.ic_crop_original_white;
                        break;
                    case "100%":
                        id = R.mipmap.ic_zoom_out_map_white;
                        break;
                    /*case "拉伸":
