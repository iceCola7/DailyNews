...
public class ThreePointLoadingView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ThreePointLoadingView);
            ...
            mBallPaint.setColor(context.getResources().getColor(R.color.primary));
            typedArray.recycle();
        }
